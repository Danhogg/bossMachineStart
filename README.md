...
I also intend to play around with the HTML/CSS to change some of the fonts and layouts and make the website more of my own style but as of yet this has not been done.
...
This section is something I am yet to complete but will certainly come back to in the near future 
...
In the current state all the required tests pass and the API works exactly as it should
